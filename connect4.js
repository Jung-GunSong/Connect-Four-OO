...
// need to create a class that will create a functional board, and allow user to play game
// create class called Game
// will start with constructor, which takes width, height, currPlayer, board
// need to create methods from all existing functions
// bigger methods can call on smaller methods
